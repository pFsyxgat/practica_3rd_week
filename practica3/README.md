...
Выводы
В результате практики была спроектирована и реализована база данных, полностью соответствующая техническому заданию. Все ограничения целостности работают корректно, реализованы все требуемые типы запросов. Полученные навыки могут быть применены в разработке информационных систем с разграничением доступа.
```
